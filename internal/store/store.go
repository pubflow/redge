...
type Store interface {
	...
	ZIncrBy(ctx context.Context, db int, key string, member []byte, delta float64) (float64, error)
	ZPopMin(ctx context.Context, db int, key string, count int64) ([]ZMember, error)
	ZPopMax(ctx context.Context, db int, key string, count int64) ([]ZMember, error)
